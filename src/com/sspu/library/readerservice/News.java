	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mback.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (s1[0] == R.drawable.back_default) {
					...
					myIntent = new Intent(News.this, BaseActivity.class);
		...
		listView.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				News.this.scrollState = scrollState;
			}
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				 ...
				 */
				if (News.this.scrollState != AbsListView.OnScrollListener.SCROLL_STATE_IDLE
	...
	public class MyThread implements Runnable {
		...
		public void run() {
			broadcastArrayList = (ArrayList<Broadcast>) qs
					.doQuery(WorkType.req_NEWS_QUERY);
	...
	class listViewAdapter extends BaseAdapter {
		...
		public View getView(int pos, View v, ViewGroup p) {
			...
			if (v == null) {
				...
				view = LayoutInflater.from(News.this).inflate(
						R.layout.list_item_01, null);
				holder.titleView = (TextView) view.findViewById(R.id.title);
				holder.createdateView = (TextView) view
				...
				view.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						Intent vIntent = new Intent(News.this,
