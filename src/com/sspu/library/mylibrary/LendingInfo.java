...
public class LendingInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.setContentView(R.layout.list_borrow_current);
		...
		mback.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (s1[0] == R.drawable.back_default) {
					...
					myIntent = new Intent(LendingInfo.this, BaseActivity.class);
					myIntent.putExtra("num", 4);
					startActivity(myIntent);
					LendingInfo.this.finish();
				}
			}
		});
		...
		listView.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				LendingInfo.this.scrollState = scrollState;
			}
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				 ...
				 */
				if (LendingInfo.this.scrollState != AbsListView.OnScrollListener.SCROLL_STATE_IDLE
	...
	class listViewAdapter extends BaseAdapter {
		...
		public View getView(int pos, View v, ViewGroup p) {
			...
			if (v == null) {
				...
				view = LayoutInflater.from(LendingInfo.this).inflate(
