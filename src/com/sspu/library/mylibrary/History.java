...
public class History extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		super.setContentView(R.layout.list_borrow_record);
		...
		mback.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (s1[0] == R.drawable.back_default) {
					...
					myIntent = new Intent(History.this, BaseActivity.class);
		...
		listView.setOnScrollListener(new OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				History.this.scrollState = scrollState;
			}
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				 ...
				 */
				if (History.this.scrollState != AbsListView.OnScrollListener.SCROLL_STATE_IDLE
	...
	public class MyThread implements Runnable {
		...
		public void run() {
			myloanbooklist = (ArrayList<Myloanbook>) qs.doQuery(
					WorkType.req_LOAN_BOOK_HISTORY, vp);
	...
	class listViewAdapter extends BaseAdapter {
		...
		public View getView(int pos, View v, ViewGroup p) {
			...
			view = LayoutInflater.from(History.this).inflate(
